...
vector<FloatStruckRect> Sampler::RadialSamples(FloatStruckRect centre, int radius, int nr, int nt)
{
	vector<FloatStruckRect> samples;
	
	FloatStruckRect s(centre);
...
vector<FloatStruckRect> Sampler::PixelSamples(FloatStruckRect centre, int radius, bool halfSample)
{
	vector<FloatStruckRect> samples;
	
	IntStruckRect s(centre);
	samples.push_back(s);
