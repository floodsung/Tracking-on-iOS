...
private:
	...
	inline double Loss(const FloatStruckRect& y1, const FloatStruckRect& y2) const
	{
		// overlap loss
	...
	double Evaluate(const Eigen::VectorXd& x, const FloatStruckRect& y) const;
